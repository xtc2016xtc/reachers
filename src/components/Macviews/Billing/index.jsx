import { storeapp,bill,google } from "../images"
    ...
    <section id="product" className={layout.sectionImgReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className="flex flex-row flex-wrap sm:mt-10 mt-6">
          <img src={storeapp} alt="apple" className="h-[42px] mr-5 w-[128px] object-contain cursor-pointer" />
          <img src={google} alt="google" className="h-[42px]  w-[128px] object-contain cursor-pointer" />
        </div>
      </div>
    </section>
  )
